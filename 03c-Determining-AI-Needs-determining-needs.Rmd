...
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g1ed2b5c8ee1_0_418")
```
...
```{r, out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g1ed2b5c8ee1_0_198")
```
...
Here we will discuss 4 bins of AI tool customization needs that we will discuss for the rest of the course. Keep in mind that these customization categories are for the purposes of discussion and not necessarily google-able terms.
...
```{r, out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g1ed2b5c8ee1_0_231")
```
...
```{r, out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g1ed2b5c8ee1_0_256")
```
...
```{r, out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g2a6104c5b4d_0_24")
```
...
Lastly, customized handling is likely the most technically demanding type of AI need. Perhaps for one reason or another you need complete transparency into the handling of the data and algorithms. Commercial AI platforms do not allow this.

```{r, out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g2a6104c5b4d_0_47")
```

However, this is an increasingly doable need to address. There are a growing number of [helpful communities](https://huggingface.co/) and developers who are experts in customizing parameters, algorithms, data handling and all kinds of inner workings of AI tools
...
```{r, out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g2a6104c5b4d_0_142")
```
...
```{r, out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g1ed2b5c8ee1_0_374")
```
...
- For **customized handling** needs, you will liekyl need to build and deploy a custom AI model.
...
```{r, out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g1ed2b5c8ee1_0_189")
```
...
```{r, out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g2a6104c5b4d_0_131")
```
...
```{r, out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g2a6104c5b4d_0_91")
```
...
```{r, out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g1ed2b5c8ee1_0_461")
```
#### Computing costs
...
```{r, out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g1ed2b5c8ee1_0_541")
```
...
Custom deployments will require more technical expertises on hand as we discussed in the previous section – think salary costs. You will need to estimate whether it is more cost efficient for you to have in house developers work on this or use borrow commercial computing infrastructure.
...
```{r, out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g2a6104c5b4d_0_101")
```
...
```{r, out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1GgsDe7dYA91RY_xCbcDRzSPGuxIMXnyHPbzL1h57pE4/edit#slide=id.g2a6104c5b4d_0_150")
```
...
- The technical expertise column describes vaguely how much teachnical expertise in house you would need to deploy the example strategy.
