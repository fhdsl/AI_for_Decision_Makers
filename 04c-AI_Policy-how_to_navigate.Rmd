...
Big technological shifts always trigger a period of explosive growth where the technology and what's possible changes incredibly quickly. We're in that stage right now with AI systems. Everyone is curious, scared, and interested in AI. ChatGPT accumulated 100 million uses in 2 months, which was much faster than many other major apps. The future workforce is using AI and bans will not be effective. Over 40% of university students use ChatGPT for coursework. Thirty-nine percent of prospective students say they wouldn’t consider going to a college that banned ChatGPT and other LLMs.
...
By negotiating an things like enterprise agreements, your organization has created a system in which employees and their actions are less likely to result in unintentional harm or data misuse. Employees will use AI and this will make them more effective. AI policies can balance their use with safety and security measures.
...
1. _Legal councsel_ that understands AI and the nuances of the rapidly changing laws can advise on regulations relevant to your organization. 
