...
<img src="resources/images/03a-Determining-AI-Needs-intro_files/figure-html//1Kg_uBagr7rdUX4okVbaxpV0QMdO4nm8o2-KQY7AECeE_g34ec17a9f7c_0_0.png" alt="This course is designed for leaders, executives, and decision-makers shaping strategy and driving innovation for use or development of AI who need to learn if premade AI solutions will work for you or custom solutions are needed and need to learn now to evaluate AI tools and resources." width="100%" style="display: block; margin: auto;" />

## Curriculum  

<img src="resources/images/03a-Determining-AI-Needs-intro_files/figure-html//1Kg_uBagr7rdUX4okVbaxpV0QMdO4nm8o2-KQY7AECeE_g34ec17a9f7c_0_8.png" alt="Pathway of more specific topics covered in this course: In this course, you’ll learn the components of good AI systems, how to determine if you can use an out of the box existing tool or if you need to make a custom tool from scratch, considerations for customizing the knowledge base, security methods, and interface, and how to evaluate your own custom AI tool." width="100%" />
