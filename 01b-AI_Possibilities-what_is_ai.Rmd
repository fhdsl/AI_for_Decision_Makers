...
As we can see from the examples above, there are many instances of technology that are incredibly useful but are not considered AI. Without getting too into the details of how they work yet, let's list some exaples of AI in the real world and their applications.
