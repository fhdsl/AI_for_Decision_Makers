...
1) **Replacing Humans and Human autonomy** - AI tools can help humans, but they are not a replacement. Humans are still much better at generalizing their knowledge to other contexts and human oversight is required (@sinz_engineering_2019). Also studies suggests that humans value content created by humans more than that of AI (@bellaiche_humans_2023).
