...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "A cartoon of a robot reading'."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1L6-8DWn028c1o0p9gwXmz90BRcy_PjPqb683nbk1gHQ/edit#slide=id.g2aaead717c1_8_0")
```
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "A robot thinking'."}
ottrpal::include_slide("hhttps://docs.google.com/presentation/d/1L6-8DWn028c1o0p9gwXmz90BRcy_PjPqb683nbk1gHQ/edit#slide=id.g2aaead717c1_8_6")
```
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "A small robot on a computer'."}
...
access to new insights and information, and their new ability to compose the story andpublish it in seconds may cause human journalists to become obsolete. This is
...
provide them, so the optimists hope, with an automated draft for a story that they willedit and enrich with their in-depth analysis, their perspectives and their narrative talents. 
...
* Design tools with responses that may ask users to be more considertate in the usage of the tool.
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Image of a robot at a door'."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1L6-8DWn028c1o0p9gwXmz90BRcy_PjPqb683nbk1gHQ/edit#slide=id.g2aaead717c1_8_83")
```
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "A cartoon of robots camping."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1L6-8DWn028c1o0p9gwXmz90BRcy_PjPqb683nbk1gHQ/edit#slide=id.g2aaead717c1_8_16")
```
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "An image of glass robots"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1L6-8DWn028c1o0p9gwXmz90BRcy_PjPqb683nbk1gHQ/edit#slide=id.g2aaead717c1_8_11")
```
