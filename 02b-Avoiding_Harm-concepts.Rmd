...
As this is an emerging technology, more guidelines will be developed and updated as the technology evolves. When you read this, more guideline and updates are likely to be available. It is important to be aware of ethical guidelines and regulations for your respective field.
...
1) **Replacing Humans and Human autonomy** - AI tools can help humans, but they are not a replacement. Humans are still much better at generalizing their knowledge to other contexts and human oversight is required (@sinz_engineering_2019). Also studies suggests that humans in some contexts value content created by humans more than that of AI (@bellaiche_humans_2023, @granulo_preference_2021).
