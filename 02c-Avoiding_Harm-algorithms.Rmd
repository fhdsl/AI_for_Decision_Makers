...
1) **Copyright Violations** - Current commercial AI tools are often not transparent about using code, text, images and other data types that may violate copyright. 
