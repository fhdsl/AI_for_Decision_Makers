...
There are situations in which we may, as a society, not want an automated response. There may even be situations in which we do not want to bias our own human judgement by that of an AI system. There may be other situations where the efficiency of AI may also be considered inappropriate. While many of these topics are still under debate and AI technology continues to improve, we challenge the readers to consider such cases given what is currently possible. We will learn throughout this course that despite the common misconception that AI systems have clearer judgement than humans, they are in fact typically just as prone to bias and sometimes even exacerbate bias (@pethig_biased_2023) and can behave in unexpected ways that we are still discovering (@gichoya_ai_2022). 

For example, it may be considered inappropriate for AI systems to be used in the justice system to determine if someone is guilty of a crime or to determine the punishment of someone found guilty of a crime.

As another example, it may be considered inappropriate for AI systems to be used in certain warfare circumstances.

### Tips for avoiding inappopriate uses
...
* Carefully consider if an AI solution is appopriate for your context.
