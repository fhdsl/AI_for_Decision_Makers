...
- **Accountability** - It is more difficult to determine who is accountable at times when separate parties may collect versus redistribute data, versus use data
- **Data Persistence** - Since data rapidly be redistributed it can be difficult to remove data (@gangarapu_ethics_2022).
...
See these articles for more information: https://www.nature.com/articles/d41586-020-03187-3 and https://learn.g2.com/ethics-of-facial-recognition
