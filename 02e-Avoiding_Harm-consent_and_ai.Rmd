...
- Empasize education of AI developers about consent considerations, guidelines, and regulations. 
- Stay up-to-date on current issues realted to consent.
- Be considerate of the data that you use for AI tools and how it was collected and if indiviuals consented to the collection and distribution of the data
- Be transparent with users about what consent practices were used for the data utalized by the tool.
